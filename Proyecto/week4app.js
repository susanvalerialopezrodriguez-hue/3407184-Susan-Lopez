...
const entityDescription = "Obra maestra del autor colombiano Gabriel García \n Márquez, imprescindible en cualquier colección \n de literatura usada.";
...
const notification = `📚 Nuevo libro disponible: \n${entityName} (${entityCode}) \n — $${mainValue.toLocaleString("es-CO")}`;
